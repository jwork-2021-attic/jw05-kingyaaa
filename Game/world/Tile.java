...
public enum Tile {
    ...
    FLOOR((char) 176, AsciiPanel.yellow),

    WALL((char) 178, AsciiPanel.brightBlack),

    BOUNDS('x', AsciiPanel.magenta),

    BRICK((char) 224, AsciiPanel.red),

    ExplosionTrace((char) 219, AsciiPanel.brightRed),

    DOOR((char) 242,AsciiPanel.brightWhite),

    
    POWER((char) 241,AsciiPanel.blue);
